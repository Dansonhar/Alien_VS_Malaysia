    ...
    build: {
        rollupOptions: {
            input: {
                ...
                durianPanic: resolve(__dirname, 'games/durian-panic.html'),
                sepakSalah: resolve(__dirname, 'games/sepak-salah.html'),
                salahTembak: resolve(__dirname, 'games/salah-tembak.html'),
            },
        },
    },
});
